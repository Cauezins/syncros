...
function CTaTwoSection() {
    return (
        ...
        <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Pronto para transformar sua equipe com o <span className="bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text">Syncros</span>?</h2>
            <p className="text-gray-200 mb-8">Experimente o Syncros hoje e veja como podemos ajudar sua equipe a ser mais eficiente.</p>
